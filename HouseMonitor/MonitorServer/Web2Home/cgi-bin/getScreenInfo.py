...
screens = {
    'login': {
        ...
        'timeline': 'true',
        'headline': 'JJM LCARS - LOGIN SCREEN',
        'hlwidth': '320px',
    ...
    'main': {
        ...
        'contentPower': {
            ...
            'headline': 'Power',
            'hlcolor': 'trk_hellgrau',
            'menu': 'Timer,Times,Devices,Commands,Macros',
            ...
            'contentTmr': {
                ...
                'onclick': 'buildScreen("jsonResponse.contentPower.contentTmr.contentMacroList","TimerCont2");/buildScreen("jsonResponse.contentPower.contentTmr.contentCommandList","TimerCont2");',
                'menu_hover': '#ff9966',
                'defContent1': 'TimerControl',
                'defContent2': 'MacroList',

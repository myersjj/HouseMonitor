...
class Adafruit_I2C(object):
    ...
    def beginTransmission(self):
        self.bus.beginTransmission()

    def endTransmission(self, stop=False):
        self.bus.endTransmission(stop)

    def requestFrom(self, quantity=0, stop=False):
        self.bus.requestFrom(quantity, stop)
